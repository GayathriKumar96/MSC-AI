...
prime_fermats_test(n): takes an integer n and tests its primality using fermat's test for 50 iterations
find_n_bit_primes(n): takes an integer n and generates 2 n-bit prime numbers randomly
